      ...
      <header className="px-[7%] pt-[80px] pb-[55px]">
        <div className="max-w-[80rem] mx-auto w-full">
          ...
          <div className="text-[18px] font-MerriRegular text-[#475467]">
            ...
            <h1>culture that empowers you to do your best work.</h1>
          </div>
        </div>
      </header>

      {/* Hiring details */}
      <div className="px-[7%] pt-[30px] pb-[80px]">
        <div className="max-w-[80rem] space-x-0 md:space-x-[100px] justify-between flex flex-col md:flex-row mx-auto w-full">
          ...
          <div className="w-full mt-8 md:mt-0">
            <img src={CareerImg} className="w-full md:w-[450px]" alt="career" />
          </div>
        </div>
      </div>
    </div>
